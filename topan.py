...
cl = CYBERTK.LINE()
cl.login(token="EsrgFLf2gmOHQsjBXEWf.5c3HczbPOjO8q9e33MwtRW.GOBGJYjXLeUXvhUXAPG0eT4wVZrPHT7MMrLqpfCzOeM=")
cl.loginResult()
...
ki2 = CYBERTK.LINE()
ki2.login(token="EscKfOGG5CcuLbV679Z2.YYeoM22Vhks1am4XV4nUSG.BWniNBOf68IKiKUIzecSSorlWybZXl2H47d1WOhXAR4=")
ki2.loginResult()

ki3 = CYBERTK.LINE()
ki3.login(token="EsMGbOiGfPO4S9M0NAN0.wGr95zTk0yWlu34UQ3qICa.fHQOqSm99g48kuMW48t6dkVLEvvG2TaTJnOegDeVaTo=")
ki3.loginResult()

ki4 = CYBERTK.LINE()
ki4.login(token="EsF4xIPjRQ1BYRPTi3V7.c3AuannFO2GnZDL3vUfOnW.MOq2ntGlM0NNrWVDW/9ylJ2sUh0ON7FG5GXTStVBqqU=")
ki4.loginResult()

ki5 = CYBERTK.LINE()
ki5.login(token="EsHbl7u7Mx1JHrMOVZt7.O0FGNtYKmYt9Qd28sB065W.ffWggO8lPXv58uD0UUvvcY7dxdljbVWj5/6gaTC72OI=")
ki5.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u6dc55a022f2a12e2950d6c89f834771e","ucb210e9b6daf1ca4b500ce31bf836eb2","u5a047de59b4ad18c0b537e2eab742270","u0b769400d35fa3680dcdd97756e16837","ua347e09d3ca43324fda83dbc49bd3ae7"]
admsa = ["u6dc55a022f2a12e2950d6c89f834771e","ucb210e9b6daf1ca4b500ce31bf836eb2","u5a047de59b4ad18c0b537e2eab742270","u0b769400d35fa3680dcdd97756e16837","ua347e09d3ca43324fda83dbc49bd3ae7"]
admin = ["u6dc55a022f2a12e2950d6c89f834771e","ucb210e9b6daf1ca4b500ce31bf836eb2","u5a047de59b4ad18c0b537e2eab742270","u0b769400d35fa3680dcdd97756e16837","ua347e09d3ca43324fda83dbc49bd3ae7"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks For Add ☆ === NB === ☆\n\n\Support By ~AliZee\n\n✯==== Creator ====✯\n\nAliZee",
    "lang":"JP",
    "comment":"Thanks For Add ☆ === NB === ☆\n\nAliZee\n\n✯==== Creator ====✯\n\nAliZee",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                return
            elif msg.text in ["Help","help","[∆√ cувєя тк™ √∆]"]:
            	if msg.from_ in admin:
...
#-------------Fungsi Tag All Start---------------#
            elif msg.text in ["tagall","Tag","Tagall"]:
                  group = cl.getGroup(msg.to)
...
#--------------------------------------------------------                    
                ...
                ki.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki2.getProfile()
                text = profile.displayName + ""
                ki2.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki3.getProfile()
                text = profile.displayName + ""
                ki3.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki4.getProfile()
                text = profile.displayName + ""
                ki4.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki5.getProfile()
                text = profile.displayName + ""
                ki5.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki6.getProfile()
                text = profile.displayName + ""
                ki6.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki7.getProfile()
                text = profile.displayName + ""
                ki7.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki8.getProfile()
                text = profile.displayName + ""
                ki8.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki9.getProfile()
                text = profile.displayName + ""
                ki9.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
                profile = ki10.getProfile()
                text = profile.displayName + ""
                ki10.sendText(msg.to, "☆ ==> NB <== AliZee ☆")
#--------------------------------------------------------                
              ...
              if msg.from_ in admin:
                ...
                if wait["autoCancel"]["on"] == True:md+="??􀆩􏿿 Auto cancel:" + str(wait["autoCancel"]["members"]) + "􀜁􀄯􏿿\n"
